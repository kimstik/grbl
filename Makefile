...
COMPILE = avr-gcc -Wall -Os -DF_CPU=$(CLOCK) -mmcu=$(DEVICE) -I. -ffunction-sections -flto -ffast-math -fno-inline-small-functions -Wl,--relax -mcall-prologues -fno-split-wide-types -fno-tree-scev-cprop
