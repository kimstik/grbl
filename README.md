...
**Platform matrix:** `atmega328p` (reference, byte-proven above) / `stm32f103` / `stm32h523` / `samd21` — all build in CI on every push (`.github/workflows/ci.yml`); more coming (`ch32v006`, `dsPIC33AK128MC102`, `hc32f460`, `sg2002` — tracked in `grbl/platform/PLAN.md`). Porting is designed to be: copy the `_template` port skeleton (in progress, `grbl/platform/PLAN.md` Phase 2), fill in the documented macro contracts, add one line to the CI build matrix.
