...
#ifndef STM32H523_GPIO_H
#define STM32H523_GPIO_H
...
// No GPIO_DREG/GPIO_PREG: H5 direction (MODER) and pull configuration (PUPDR)
// are 2-bit-per-pin fields, so every macro that would touch them is
