...
// had also flagged it (ci/warn_baseline_stm32f103.txt carried the line as
...
// this (platform.md/README: not yet run on real hardware). See PLAN.md
// BUG #26 - stm32f411 and stm32h523 shared the identical defect (same
// donor pin map) and get the same PB2 fix.
...
// h523, the f103 twin was fixed in the same wave) - a comment alone did not
// stop the copy-paste regression the first time.
...
// consistency audit, 2026-07-26): defined here and in stm32f411/h523/
...
// common/cortexm/cortexm_critical.h, shared verbatim with stm32f411,
