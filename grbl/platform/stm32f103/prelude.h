...
/*
  ...
  this Cortex-M3 (no FPU at all, 64-bit double) the math.h prototypes make
  every such call promote its float arguments to genuine 64-bit double and
  pull DP libm + DP soft-float into the binary.
