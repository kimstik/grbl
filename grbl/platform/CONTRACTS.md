...
## §NEW. A clock constant must be wide enough for its worst real value, not its current one (BUG #18 class)
...
## §NEW. A warning-baseline entry requires a recorded judgement, not a resemblance
